        ...
        <div className="mt-16">
          <form action="">
            <div className="mb-6">
              ...
              <input
                type="email"
                className="py-3 p1-4 text-sm rounded-md w-full bg-special-mainBg border border-gray-03 text-gray-01 focus:border-black focus:outline-none focus:ring-0"
            ...
            <div className="mb-3">
              <input
                ...
                id="status"
              />
              <label htmlFor="status" className="text-sm text-gray-01 m1-6">
                Keep me signed in
              </label>
            </div>
            <button
